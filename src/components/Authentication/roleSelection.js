    ...
    <div className="container" style={{marginBottom:'180px'}}>
      ...
      <div className="row ">
        ...
        <div className="col-sm-4 ">
          <div className="card p-4 blue lighten-5 pink-text font-weight-bold">
            <div className="card-body ">
              <h4 className="card-title">Signup As a student</h4>
        ...
        <div className="col-sm-4 ">
          <div className="card p-3 blue lighten-5 pink-text font-weight-bold">
            <div className="card-body">
              <h4 className="card-title">Signup As a Teacher</h4>
